<%@ Page Title="MemberProfile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="MemberProfile.aspx.cs" Inherits="_0617.MemberProfile" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
            ...
            <p>
                ...
                <asp:Label ID="Label1" runat="server" Text="Label">其他 Others</asp:Label>
                <br /><br />
